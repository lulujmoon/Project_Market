		...
		<div class="top__info">
			...
			<div class="top__btns">
				...
				<c:if test="${principal.username != product.username}">
					...
					<c:if test="${chat eq 0}">
						<div class="top-btn btn-contact"><a type="button" href="/chat/chatSendInList?room=0&otherUser=${seller.username}&content=${principal.username}님이 ${product.productName}을 구매하길 원합니다!"${product.productName} onclick="if(confirm('연락하시겠습니까?')==false){return false;}">연락하기</a></div>
					</c:if>
