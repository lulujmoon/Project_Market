...
<body>
	...
	<div class="table-box2">
		...
		<div class="btn-report" onclick="openReport('${social.socialNum}')"><i class="fas fa-exclamation-triangle"></i> 신고</div>
	</div>
	<div class="hidden">
		...
		<c:forEach items="${list}" var="comment">
			<ul class="table-box2">
				<li>
					...
					</c:catch> ${comment.commentContent}
				</li>
				<li>
					<div class="container">${comment.username}<br>${comment.commentDate}
